...
db = plyvel.DB('/data1/tron/100G/output-directory/database/trans')
blockIndexDB = plyvel.DB('/data1/tron/100G/output-directory/database/block-index')
blockDB = plyvel.DB('/data1/tron/100G/output-directory/database/block')
# db = plyvel.DB('/data1/tron/100G/output-directory/database/transactionHistoryStore')

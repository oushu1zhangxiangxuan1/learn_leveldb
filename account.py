...
db = plyvel.DB("/data1/tron/output-directory/database/trans")
blockIndexDB = plyvel.DB("/data1/tron/output-directory/database/block-index")
blockDB = plyvel.DB("/data1/tron/output-directory/database/block")
accountDB = plyvel.DB("/data1/tron/output-directory/database/account")

accountIndexDB = plyvel.DB("/data1/tron/output-directory/database/account-index") # account name to accountid
accountIdIndexDB = plyvel.DB("/data1/tron/output-directory/database/accountid-index")
# db = plyvel.DB('/data1/tron/output-directory/database/transactionHistoryStore')
